...
#	display_alert "SDCARD = ${SDCARD}" "" "dbg"
	...
	cp $SRC/cache/sources/linux-mainline/aosc-sunxi64-5.1-rc4-pinetab/arch/arm64/boot/dts/allwinner/sun50i-a64-sopine-baseboard.dtb $SDCARD/boot/dtb/allwinner
	cp $SRC/cache/sources/linux-mainline/aosc-sunxi64-5.1-rc4-pinetab/arch/arm64/boot/dts/allwinner/overlay/sun50i-a64-fixup.scr $SDCARD/boot/dtb/allwinner/overlay
	cp $SRC/cache/sources/linux-mainline/aosc-sunxi64-5.1-rc4-pinetab/arch/arm64/boot/dts/allwinner/overlay/sun50i-a64-fixup.scr-cmd $SDCARD/boot/dtb/allwinner/overlay
